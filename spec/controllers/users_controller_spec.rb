...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show the correct micropost count" do
      ...
      get :show, id: @user
      response.should have_selector("span.microposts span", content: "2")
    end
  end
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should have a welcome message" do
        post :create, user: @attr
        flash[:success].should =~ /welcome to ruby twitter/i
      end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      it "shoul dhave a flash message" do
        put :update, id: @user, user: @attr
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for signed-in users" do
      ...
      it "should require matching sers for 'edit'" do
        get :edit, id: @user
        response.should redirect_to(root_path)
      end
